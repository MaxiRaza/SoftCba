...
<html>
    <head>       
        ...
        <title>SoftCba - Listado Cursos</title>     
    ...
    <body>
        ...
        <div class="tituloContenedor">
            ...
            <a href="Cursos?modo=alta" class="btn btn-info">Registrar Curso</a>
        </div>
            ...
            <tbody>
                <c:forEach items="${listadoCursos}" var="c">
                    <tr>
                        <td> ${c.idCurso}  </td>
                        <td> ${c.nombre}  </td>
                        <td> ${c.duracion}  Meses </td>
                        <td> ${c.materia}  </td>
                        <td><a href="Cursos?modo=editar&idCurso=${c.idCurso}" class="btn btn-warning">Editar</a></td>
                        <td><a href="Cursos?modo=eliminar&idCurso=${c.idCurso}" class="btn btn-danger">Eliminar</a></td>
                    </tr>    
                </c:forEach>                
            </tbody>
        </table>       
