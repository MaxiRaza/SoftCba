...
<html>
    <head>
        ...
        <title>SoftCba - Registrar Programa</title>
        ...
        <div class="tituloContenedor"> 
            <form method="Post" enctype="multipart/form-data" action="Programas">
                ...
                <div class="form-check">
                    <input type="checkbox" name="chkEstaHabilitado" class="form-check-input" id="exampleCheck1" value="habilitado">
                ...
                <div class="moverA">
                    ...
                    <button type="submit" class="btn btn-success moverI">Registrar programa</button>             
                </div>    
            </form       
        </div>
